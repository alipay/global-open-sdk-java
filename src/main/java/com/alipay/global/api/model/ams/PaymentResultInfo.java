...
public class PaymentResultInfo {
  ...
  /**
   * The payment card category. Valid vaules are: CONSUMER: the personal card COMMERCIAL: the
   * business card
   */
   ...
   * lowValue: Transactions below €30 may be exempt from Strong Customer Authentication, if certain
  ...
  /**
   * Indicates whether the transaction was processed with the primary account number (PAN) or a
   * network token. PAN: The transaction was processed using the PAN. NETWORK_TOKEN: The transaction
   * was processed using a network token provided by the merchant or Antom.
   */
