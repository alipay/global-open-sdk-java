...
/** Full credit note object for notifyCreditNote. Contains status, amounts, refund details, and line items. */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CreditNoteInfo {
  ...
  /** The current status. Valid values: ISSUED, PROCESSING, REFUNDED, REFUND_FAILED, VOIDED. Maximum length: 32 characters. */
  ...
  /** The refund tracking status. Present when type is POST_PAYMENT and refund occurred. Maximum length: 32 characters. */
  private String refundStatus;

  /** The refund transaction ID in the payment system. Present when type is POST_PAYMENT and refund occurred. Maximum length: 64 characters. */
  ...
  /** The refund timestamp. Present when status is REFUNDED. ISO 8601 format. Maximum length: 29 characters. */
  private String refundedAt;

  /** The void timestamp. Present when status is VOIDED. ISO 8601 format. Maximum length: 29 characters. */
