...
public class AlipayRefundNotify extends AlipayNotify {
  ...
  /**
   * The unique ID that is assigned by Alipay to identify a refund. A one-to-one correspondence
   * between paymentId and paymentRequestId exists
   */
  ...
  /**
   * The refund settlement amount, which equals the refund amount multiplied by the value of
   * settlementQuote
   */
