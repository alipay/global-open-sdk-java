...
public class AlipayCreateTransferRequest extends AlipayRequest<AlipayCreateTransferResponse> {
  ...
  /**
   * The unique ID assigned by the marketplace to identify a transfer request. More information:
   * This field is an API idempotency field.For requests that are initiated with the same value of
