...
public class RegistrationDemoCode {
  ...
  public static AlipayMerchantRegistrationInfoQueryRequest
      buildAlipayMerchantRegistrationInfoQueryRequest() {
    final AlipayMerchantRegistrationInfoQueryRequest request =
        new AlipayMerchantRegistrationInfoQueryRequest();
    request.setReferenceMerchantId(referenceMerchantId);
    return request;
  }

  public static AlipayMerchantRegistrationInfoQueryResponse queryRegistrationInfo(
      final AlipayMerchantRegistrationInfoQueryRequest request) {
    Object obj =
  ...
  public static AlipayMerchantRegistrationStatusQueryRequest
      buildAlipayMerchantRegistrationStatusQueryRequest() {
    final AlipayMerchantRegistrationStatusQueryRequest request =
  ...
  public static AlipayMerchantRegistrationStatusQueryResponse queryRegistrationStatus(
      final AlipayMerchantRegistrationStatusQueryRequest request) {
    Object obj =
        RetryExecutor.execute(
            REGISTER_RETRY_COUNT,
  ...
  public static AlipayMerchantRegistrationResponse registerMerchant(
      final AlipayMerchantRegistrationRequest request) {
