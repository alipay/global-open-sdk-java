...
/**
 * The demo Code mainly shows the correct use of API, and the specific implementation needs to be
        ...
        new Callback() {
          ...
          public RetryResult doProcess() {
            ...
            if (ResultStatusType.U.equals(payResult.getResultStatus())) {
              ...
              ArrayList<Integer> pauseInterval =
                  (ArrayList<Integer>) Arrays.asList(2, 4, 8, 16, 32);
