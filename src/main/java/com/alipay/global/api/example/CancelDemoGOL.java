...
public class CancelDemoGOL {
    ...
    public static void main(String[] args) {
        ...
        // The original payment ID of the payment request to be canceled,
        // generated by Alipay to uniquely identify the payment when the merchant initiates the original payment.
        // paymentId and paymentRequestId cannot both be null.
        // A one-to-one correspondence between paymentId and paymentRequestId exists.
        alipayPayCancelRequest.setPaymentRequestId("Replace by your paymentRequestId");
        alipayPayCancelRequest.setPaymentId("Replace by your paymentId");
        try {
