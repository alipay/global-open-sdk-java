...
public class CustomsDemoCode {
  ...
  public static void main(String[] args) {
    ...
    if (response != null) {
      ...
      if (ResultStatusType.S.equals(result.getResultStatus())) {
        ...
        AlipayCustomsQueryResponse customsQueryResponse =
            queryCustomsDeclare(buildAlipayCustomsQueryRequest(requestIds));
  ...
  public static AlipayCustomsQueryResponse queryCustomsDeclare(
      final AlipayCustomsQueryRequest request) {
    Object obj =
        RetryExecutor.execute(
            QUERY_DECLARE_RETRY_COUNT,
            new Callback() {
              @Override
              public RetryResult doProcess() {
